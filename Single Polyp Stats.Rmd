...
adonis(mData.dist~PolypZone2, data=mData.sd)
pairwise.adonis(mData.dist, mData.sd$PolypZone2)
...
pairwise.adonis(mData.dist, mData.sd$Area)
...
adonis(mData.dist~ATTRIBUTE_Colony_number*ATTRIBUTE_Branch_Letter*Area, data=mData.sd)
# 
#                                                       Df SumsOfSqs MeanSqs F.Model      R2 Pr(>F)
...
adonis(mData.dist~ATTRIBUTE_Branch_Letter*Area, data=mData.sd)
...
set.seed(30)
adonis(mData.Branch957.A.dist~Area, data=mData.Branch957.A.sd)
#           Df SumsOfSqs MeanSqs F.Model R2 Pr(>F)
...
mod<- lmer(bc.dist_sqrt~PolypZones + (1|Coral) + (1|Coral:Branch) , data=Dist.compare.df )
anova(mod)
summary(mod)
r.squaredGLMM(mod)
